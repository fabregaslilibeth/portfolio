                ...
                <div className="max-w-4xl mx-auto">
                  <h1 className="text-6xl font-bold mb-6">
                    {(projects[hoveredProject - 1]?.name).split('').map((letter, index) => {
                      const randomRotation = (Math.random() - 0.5) * 720; // Random rotation between -360 and 360 degrees
                      const exitRotation = (Math.random() - 0.5) * 1080; // Even more chaotic exit rotation
                      const exitDelay = Math.random() * 0.4; // Random exit delay
                      ...
                      return (
                        <motion.span
                          ...
                          transition={{
                            delay: 0.5 + (Math.random() * 0.8), // Random delay between 0.5-1.3s
                            duration: 0.8,
                            type: "spring",
                            damping: 8,
                            stiffness: 80
                  ...
                  <motion.p 
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{
                      delay: 2.1, // Wait for cereal letters to finish (max delay 1.3s + duration 0.8s = 2.1s)
                      duration: 0.6,
                      ease: "easeOut"
                    }}
                    viewport={{ once: true }}
